...
$('#todoaddtaskdiv').click(function(){
    console.log("hjj")
    zavd++;
    $('#tododivbody').html( $('#tododivbody').html()+"<div ondblclick=\"rmdiv(id)\" contenteditable=\"true\" class='todotaskcl' id=\"todotask"+zavd+"\""+" ><h3 class=\"todotaskhead\">Нове завдання"+"</h3><p class=\"todotaskbody\">Опис</p></div>");
...
$('#alarmadddiv').click(function(){
    console.log("hjj")
    alarmcount++;
    $('#alarmdivbody').html( $('#alarmdivbody').html()+"<div ondblclick=\"rmdiv(id)\" contenteditable=\"true\" class='todotaskcl' id=\"todotask"+alarmcount+"\""+" ><strong>"+"</strong><br><p class=\"timetext\">"+timeq()+"</p></div>");
...
$("#alarmdiv").swipe( {
        swipeLeft: function(){$('#rozklad').click() },
        swipeRight:function(){ $('#todo').click()},
        threshold:75
});

$("#rozkladdiv").swipe( {
        swipeLeft: function(){$('#chas').click() },
        swipeRight:function(){ $('#alarm').click()},
        threshold:75
});

$("#chasdiv").swipe( {
        swipeLeft: function(){$('#todo').click() },
        swipeRight:function(){ $('#rozklad').click()},
        threshold:75
});

$("#tododiv").swipe( {
        swipeLeft: function(){$('#alarm').click() },
        swipeRight:function(){ $('#chas').click()},
        threshold:75
});
...
//var pages=["#rozkladdiv", "#chasdiv", "#tododiv", "#alarmdiv", ]
